...
TOWN_LOCATIONS: Dict[str, Dict] = {
    "plaza": {
        ...
        "bounds": {"x1": 47, "y1": 31, "x2": 51, "y2": 35},
    },
    "cafe": {
        "x": 32.0,
        "y": 34.0,
        ...
        "bounds": {"x1": 30, "y1": 32, "x2": 34, "y2": 36},
    },
    "library": {
        "x": 38.0,
        "y": 21.0,
        ...
        "bounds": {"x1": 36, "y1": 19, "x2": 40, "y2": 23},
    },
    "town_hall": {
        "x": 62.0,
        "y": 28.0,
        ...
        "bounds": {"x1": 60, "y1": 26, "x2": 64, "y2": 30},
    },
    "apartment": {
        "x": 37.0,
        "y": 41.0,
        "label": "Apartment",
        "activities": ["go inside"],
        "bounds": {"x1": 35, "y1": 39, "x2": 39, "y2": 43},
    },
    "barn": {
        "x": 60.0,
        "y": 36.0,
        "label": "Barn",
        "activities": ["check on animals", "rest in the hay"],
        "bounds": {"x1": 58, "y1": 34, "x2": 62, "y2": 38},
    },
    "shop": {
        "x": 47.0,
        "y": 48.0,
        "label": "Shop",
        "activities": ["browse goods", "chat with the shopkeeper"],
        "bounds": {"x1": 45, "y1": 46, "x2": 49, "y2": 50},
    },
    "home": {
        "x": 53.0,
        "y": 40.0,
        ...
        "bounds": {"x1": 51, "y1": 38, "x2": 55, "y2": 42},
    },
}
