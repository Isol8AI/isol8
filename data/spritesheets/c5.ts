...
export const data: SpritesheetData = {
  frames: {
    ...
    right: {
      frame: { x: 576, y: 96, w: 48, h: 48 },
      sourceSize: { w: 48, h: 48 },
      spriteSourceSize: { x: 0, y: 0 },
    },
    right2: {
      frame: { x: 624, y: 96, w: 48, h: 48 },
      sourceSize: { w: 48, h: 48 },
      spriteSourceSize: { x: 0, y: 0 },
    },
    right3: {
      frame: { x: 672, y: 96, w: 48, h: 48 },
      sourceSize: { w: 48, h: 48 },
      spriteSourceSize: { x: 0, y: 0 },
    },
    up: {
      frame: { x: 576, y: 144, w: 48, h: 48 },
      sourceSize: { w: 48, h: 48 },
      spriteSourceSize: { x: 0, y: 0 },
    },
    up2: {
      frame: { x: 624, y: 144, w: 48, h: 48 },
      sourceSize: { w: 48, h: 48 },
      spriteSourceSize: { x: 0, y: 0 },
    },
    up3: {
      frame: { x: 672, y: 144, w: 48, h: 48 },
      sourceSize: { w: 48, h: 48 },
      spriteSourceSize: { x: 0, y: 0 },
    },
  },
