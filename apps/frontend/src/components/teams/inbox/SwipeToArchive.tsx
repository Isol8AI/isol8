// Ported from upstream Paperclip's SwipeToArchive.tsx
// (paperclip/ui/src/components/SwipeToArchive.tsx) (MIT, (c) 2025 Paperclip AI).
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          selected ? "bg-stone-100 dark:bg-stone-800" : "bg-background",
        )}
        style={{
