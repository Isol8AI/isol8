...
| 4 | Command palette (cmd+k for fast nav/search/create across agents/issues/projects) | S | Done | — | [2026-05-05-teams-command-palette.md](../plans/2026-05-05-teams-command-palette.md) | (#4 link) |
