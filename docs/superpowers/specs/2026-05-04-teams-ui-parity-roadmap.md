...
| 3 | Inbox **deep port** (full Paperclip parity: tabs, filters, search, keyboard, archive/undo + detail pages) | XL | Spec | [2026-05-04-teams-inbox-deep-port-design.md](./2026-05-04-teams-inbox-deep-port-design.md) | — | — |
