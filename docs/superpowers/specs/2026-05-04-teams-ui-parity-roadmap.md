...
| 3 | Inbox **deep port** (full Paperclip parity: tabs, filters, search, keyboard, archive/undo + detail pages) | XL | In progress (3a ✅, 3b/c/d pending) | [2026-05-04-teams-inbox-deep-port-design.md](./2026-05-04-teams-inbox-deep-port-design.md) | [#3a BFF plan](../plans/2026-05-04-teams-inbox-bff.md) | [#524](https://github.com/Isol8AI/isol8/pull/524) (#3a) |
